Feature: mnm_ops_dataentrySiteBackendDBVPN Validation

  Scenario Outline: Validate mnm_ops_dataentrySiteBackendDBVPN
    ...
    When User click on Menu item & verify breadcrum
      ...
      | Data Entry > Site Backend DB and VPN| Site Backend Database Name and VPN |
    ##And User clicks on "Total Servers" link on the page
    ##And User clicks on the Total Servers link on the page
    Then User should be on the 'Site Backend Database Name and VPN' page
