Feature: mnm_ops_dataentryWEOLDate Validation

  Scenario Outline: Validate mnm_ops_dataentryWEOLDate
   ...
   # And User click on the Operations link(tab)
    ...
    Then User should be on the 'Software End of Life Date' page
