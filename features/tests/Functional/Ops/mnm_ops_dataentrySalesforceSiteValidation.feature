Feature: mnm_ops_dataentrySalesforceSiteValidation Validation

  Scenario Outline: Validate mnm_ops_dataentrySalesforceSiteValidation
    ...
    Then User should be on the 'Salesforce Site Validation' page
